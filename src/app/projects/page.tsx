...
const allProjects = [
    ...
    },
    {
        ...
        description:
            "Premium casting workspace and audition pipeline for regional cinema. A native mobile application providing a responsive pipeline for casting calls, self-tapes, and instant swipe-shortlisting review ΓÇö eliminating messy WhatsApp and Google Drive clutter.",
...
const ProjectCard = ({ project, i }: { project: any; i: number }) => {
    ...
    // Red/blue line 3D scroll animation (mobile only)
    ...
    return (
        <div ref={containerRef} className="py-4 sm:py-8">
                        ...
                        <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-2">
                            ...
                            {project.previewImage && (
                                ...
                                >
                                    ...
                                    {/* Floating screenshot preview popover ΓÇö desktop only */}
                                    <AnimatePresence>
                                        {isHovered && !isMobile && (
                                            <motion.div
            ...
            {/* Lightbox Modal ΓÇö Portal based, perfectly centered on mobile & desktop */}
            {project.previewImage && (
                <ProjectLightbox
    ...
    return (
        <section id="projects" className="bg-white py-16 sm:py-20 md:py-24 perspective-1000">
            <div className="section-container max-w-5xl mx-auto">
                ...
                {/* Projects ΓÇö 3D case study rows */}
